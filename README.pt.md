...
- 🖥️ **Tela de monitoramento (NOC)** — quadros grandes agrupados por grupo,
  arrastar e soltar para organizar, e modo tela cheia para uma TV.
...
- [x] Tela de monitoramento NOC (quadros agrupados, arrastar e soltar, tela cheia)
